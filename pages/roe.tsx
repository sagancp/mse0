...
export default function ROE() {
    ...
    useEffect(() => {
        getGoogleSheetsData("process_data!A1:z99").then((res) => {
            ...
            result?.map((e: any) => {
                ...
                processed.sort((b, a) => {
                    return a.roe_2023_4Q - b.roe_2023_4Q;
                });
    ...
    return (
        <Container maxWidth="lg" className="flex justify-center align-middle">
            ...
            %Return on Equity / Өөрийн хөрөнгийн өгөөжийн хувь
            </h1>
            ...
            {data && (
                            ...
                            xAxis={[
                                {
                                    ...
                                    data: data
                                        ?.filter(
                                            (e: any) =>
                                                e.roe_2023_4Q > 0
                                        ).sort((a: any, b: any) => b.roe_2023_4Q - a.roe_2023_4Q)
                                        .map((e: any) => e.ticker),
                                    scaleType: "band",
                                },
                            ]}
                            series={[
                                {
                                    data: data
                                        ...
                                        .map((e: any) => e.roe_2023_4Q),
                                        // label:"roe ratio / Үнэ өөрийн хөрөнгийн харьцаа"
                                },
                            ]}
                            width={1200}
                            height={300}
                ...
                {data?.sort((a: any, b: any) => b.roe_2023_4Q - a.roe_2023_4Q).map((v: any, i: number) => (
                    <div
                        className={`flex justify-between  w-32  p-5 m-3 rounded ${
                            v.roe_2023_4Q < 10.0
                                ? "bg-red-300"
                                : v.roe_2023_4Q<20.0 ?"bg-gray-400" :"bg-teal-400"
                        }`}
                        key={i}>
                        {/* <h1>{v.no}</h1> */}
