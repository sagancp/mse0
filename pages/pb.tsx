...
export default function PB() {
    ...
    useEffect(() => {
        getGoogleSheetsData("process_data!A1:z99").then((res) => {
            ...
            result?.map((e: any) => {
                ...
                processed.sort((b, a) => {
                    return a.pb_2023_4Q - b.pb_2023_4Q;
                });
    ...
    return (
        <Container maxWidth="lg" className="flex justify-center align-middle">
            ...
            PB ratio / Үнэ өөрийн хөрөнгийн харьцаа
            </h1>
            ...
            {data && (
                            ...
                            xAxis={[
                                {
                                    ...
                                    data: data
                                        ?.filter(
                                            (e: any) =>
                                                e.pb_2023_4Q > 0
                                        ).sort((a: any, b: any) => b.pb_2023_4Q - a.pb_2023_4Q)
                                        .map((e: any) => e.ticker),
                                    scaleType: "band",
                                },
                            ]}
                ...
                {data?.sort((a: any, b: any) => a.pb_2023_4Q - b.pb_2023_4Q).map((v: any, i: number) => (
                    <div
                        className={`flex justify-between  w-32  p-5 m-3 rounded ${
                            v.pb_2023_4Q > 3.0
                                ? "bg-red-300"
                                : v.pb_2023_4Q>1.0 ?"bg-gray-400" :"bg-teal-400"
                        }`}
                        key={i}>
                        {/* <h1>{v.no}</h1> */}
